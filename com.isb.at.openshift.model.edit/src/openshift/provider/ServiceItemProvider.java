...
/**
 * This is the item provider adapter for a {@link openshift.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addServiceManagePodPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Service Manage Pod feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addServiceManagePodPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_serviceManagePod_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_serviceManagePod_feature", "_UI_Service_type"),
				 OpenshiftPackage.Literals.SERVICE__SERVICE_MANAGE_POD,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OpenshiftPackage.Literals.SERVICE__NAME,
				 true,
				 false,
				 false,
