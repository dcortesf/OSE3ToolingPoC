...
public class CreateEReferenceConnectionFeature extends AbstractCreateConnectionFeature
		implements ICreateConnectionFeature {

	public CreateEReferenceConnectionFeature(IFeatureProvider fp) {
		super(fp, "EReference", "Creates a new EReference between two Templates");
	}
