...
public class AddPodFeature extends AbstractAddShapeFeature implements
		IAddFeature {
	...
	private static final IColorConstant E_CLASS_TEXT_FOREGROUND =
	    ...
	    public AddPodFeature(IFeatureProvider fp) {
	        super(fp);
	    }
	...
	public boolean canAdd(IAddContext context) {
		...
		if(context.getNewObject() instanceof Pod){
	...
	public PictogramElement add(IAddContext context) {
		Pod addedClass = (Pod) context.getNewObject();
        ...
        // SHAPE WITH TEXT
        {
            ...
            Text text = gaService.createText(shape, "Pod");
