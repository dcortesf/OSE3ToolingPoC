...
public class TemplateImpl extends MinimalEObjectImpl.Container implements Template {
	/**
	 * The cached value of the '{@link #getTemplateHasServices() <em>Template Has Services</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTemplateHasServices()
	 * @generated
	 * @ordered
	 */
	protected EList<Service> templateHasServices;
	...
	protected EClass eStaticClass() {
		return OpenshiftPackage.Literals.TEMPLATE;
	}
	 ...
	 * @generated
	 */
	public EList<Service> getTemplateHasServices() {
		if (templateHasServices == null) {
			templateHasServices = new EObjectResolvingEList<Service>(Service.class, this, OpenshiftPackage.TEMPLATE__TEMPLATE_HAS_SERVICES);
		}
		return templateHasServices;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenshiftPackage.TEMPLATE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenshiftPackage.TEMPLATE__TEMPLATE_HAS_SERVICES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case OpenshiftPackage.TEMPLATE__TEMPLATE_HAS_SERVICES:
				getTemplateHasServices().clear();
				getTemplateHasServices().addAll((Collection<? extends Service>)newValue);
				return;
			case OpenshiftPackage.TEMPLATE__NAME:
